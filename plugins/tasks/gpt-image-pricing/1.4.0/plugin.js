...
export const meta = {
  ...
  usageExamples: [
    { label: "1K · 1 image", facts: { request_count: 1, image_count: 1, resolution: "1024x1024" } },
    { label: "2K · 1 image", facts: { request_count: 1, image_count: 1, resolution: "1536x1024" } },
  ],
  protocols: [
    {
      name: "openai_image",
...
function factsFromRequest(ctx) {
  ...
  return { request_count: 1, image_count: req.n, resolution: req.size };
}
