...
export const meta = {
  ...
  usageExamples: [
    { label: "1K · standard · 1 image", facts: { request_count: 1, image_count: 1, resolution: "1024x1024", quality: "medium" } },
    { label: "2K · high · 1 image", facts: { request_count: 1, image_count: 1, resolution: "1536x1024", quality: "high" } },
  ],
  protocols: [
    {
      name: "openai_image",
...
function factsFromRequest(ctx) {
  ...
  return { request_count: 1, image_count: req.n, resolution: req.size, quality: req.quality };
}
