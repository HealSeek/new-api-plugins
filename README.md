...
| `gpt-image-pricing` | GPT Image generation and editing with resolution-aware billing | `POST /v1/images/generations`, `POST /v1/images/edits` | `gpt-image-1`, `gpt-image-1-mini`, `gpt-image-1.5`, `gpt-image-2`, `gpt-image-2.5-sunburst`, `gpt-image-2.5-flare` |
